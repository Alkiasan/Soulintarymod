...
public class OrangeWindowOff2PaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_2_pane")
	public static final Block block = null;
	public OrangeWindowOff2PaneBlock(SoulinmodModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_2_pane");
		}
