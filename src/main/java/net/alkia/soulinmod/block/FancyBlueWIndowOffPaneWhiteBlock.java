...
public class FancyBlueWIndowOffPaneWhiteBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:fancy_blue_w_indow_off_pane_white")
	public static final Block block = null;
	public FancyBlueWIndowOffPaneWhiteBlock(SoulinmodModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("fancy_blue_w_indow_off_pane_white");
		}
