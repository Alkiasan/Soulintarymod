...
public class HardenedVoidBlock extends SoulinmodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A large chunk of hardened void. Its dense and heavy"));
			list.add(new StringTextComponent("although it is still cold to the touch."));
		}
