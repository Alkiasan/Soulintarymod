...
public class OrangeWindowOff2Block extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_2")
	public static final Block block = null;
	public OrangeWindowOff2Block(SoulinmodModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_2");
		}
