...
public class OrangeWindowOffBlackpaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_blackpane")
	public static final Block block = null;
	public OrangeWindowOffBlackpaneBlock(SoulinmodModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_blackpane");
		}
