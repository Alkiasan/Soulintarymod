...
public class OrangeWindowoff2WhiteBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_windowoff_2_white")
	public static final Block block = null;
	public OrangeWindowoff2WhiteBlock(SoulinmodModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_windowoff_2_white");
		}
