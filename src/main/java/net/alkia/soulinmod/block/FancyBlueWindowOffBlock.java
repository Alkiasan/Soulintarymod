...
public class FancyBlueWindowOffBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:fancy_blue_window_off")
	public static final Block block = null;
	public FancyBlueWindowOffBlock(SoulinmodModElements instance) {
		super(instance, 123);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fancy_blue_window_off");
		}
