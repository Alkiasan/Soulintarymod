...
public class OrangeWindowOffPaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_pane")
	public static final Block block = null;
	public OrangeWindowOffPaneBlock(SoulinmodModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_pane");
		}
