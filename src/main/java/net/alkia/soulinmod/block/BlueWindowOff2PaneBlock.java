...
public class BlueWindowOff2PaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:blue_window_off_2_pane")
	public static final Block block = null;
	public BlueWindowOff2PaneBlock(SoulinmodModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_window_off_2_pane");
		}
