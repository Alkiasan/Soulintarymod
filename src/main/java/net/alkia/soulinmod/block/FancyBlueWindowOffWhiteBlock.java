...
public class FancyBlueWindowOffWhiteBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:fancy_blue_window_off_white")
	public static final Block block = null;
	public FancyBlueWindowOffWhiteBlock(SoulinmodModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fancy_blue_window_off_white");
		}
