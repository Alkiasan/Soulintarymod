...
public class BlueWIndowOff2Block extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:blue_w_indow_off_2")
	public static final Block block = null;
	public BlueWIndowOff2Block(SoulinmodModElements instance) {
		super(instance, 109);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_w_indow_off_2");
		}
