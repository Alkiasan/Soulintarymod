...
public class BlackBlockBlock extends SoulinmodModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(
					...
					Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000).lightValue(0));
