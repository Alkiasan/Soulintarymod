...
public class SquareBlueWindowOffBlackBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:square_blue_window_off_black")
	public static final Block block = null;
	public SquareBlueWindowOffBlackBlock(SoulinmodModElements instance) {
		super(instance, 115);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("square_blue_window_off_black");
		}
