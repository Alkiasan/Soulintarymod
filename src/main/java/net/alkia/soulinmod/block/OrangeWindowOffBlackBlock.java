...
public class OrangeWindowOffBlackBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_black")
	public static final Block block = null;
	public OrangeWindowOffBlackBlock(SoulinmodModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_black");
		}
