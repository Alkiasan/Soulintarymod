...
public class FOOPBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:foop")
	public static final Block block = null;
	public FOOPBlock(SoulinmodModElements instance) {
		super(instance, 148);
	}
