...
public class BlueWindowOffPaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:blue_window_off_pane")
	public static final Block block = null;
	public BlueWindowOffPaneBlock(SoulinmodModElements instance) {
		super(instance, 108);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_window_off_pane");
		}
