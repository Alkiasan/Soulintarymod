...
public class OrangeWindowOff1Block extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:orange_window_off_1")
	public static final Block block = null;
	public OrangeWindowOff1Block(SoulinmodModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("orange_window_off_1");
		}
