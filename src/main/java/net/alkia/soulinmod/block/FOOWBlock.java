...
public class FOOWBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:foow")
	public static final Block block = null;
	public FOOWBlock(SoulinmodModElements instance) {
		super(instance, 149);
	}
