...
public class BlueWindow3Block extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:blue_window_3")
	public static final Block block = null;
	public BlueWindow3Block(SoulinmodModElements instance) {
		super(instance, 106);
	}
