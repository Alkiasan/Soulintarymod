...
public class BlueWindowOffBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:blue_window_off")
	public static final Block block = null;
	public BlueWindowOffBlock(SoulinmodModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_window_off");
		}
