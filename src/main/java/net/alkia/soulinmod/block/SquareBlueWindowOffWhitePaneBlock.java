...
public class SquareBlueWindowOffWhitePaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:square_blue_window_off_white_pane")
	public static final Block block = null;
	public SquareBlueWindowOffWhitePaneBlock(SoulinmodModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("square_blue_window_off_white_pane");
		}
