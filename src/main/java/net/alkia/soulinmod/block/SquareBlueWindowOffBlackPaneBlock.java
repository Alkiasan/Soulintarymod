...
public class SquareBlueWindowOffBlackPaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:square_blue_window_off_black_pane")
	public static final Block block = null;
	public SquareBlueWindowOffBlackPaneBlock(SoulinmodModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("square_blue_window_off_black_pane");
		}
