...
public class SquareBlueWindowOffWhiteBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:square_blue_window_off_white")
	public static final Block block = null;
	public SquareBlueWindowOffWhiteBlock(SoulinmodModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("square_blue_window_off_white");
		}
