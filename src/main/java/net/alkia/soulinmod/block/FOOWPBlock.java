...
public class FOOWPBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:foowp")
	public static final Block block = null;
	public FOOWPBlock(SoulinmodModElements instance) {
		super(instance, 150);
	}
