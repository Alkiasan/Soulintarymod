...
public class FancyBlueWindowOffPaneBlock extends SoulinmodModElements.ModElement {
	@ObjectHolder("soulinmod:fancy_blue_window_off_pane")
	public static final Block block = null;
	public FancyBlueWindowOffPaneBlock(SoulinmodModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("fancy_blue_window_off_pane");
		}
